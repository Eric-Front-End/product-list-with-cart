...
export const ProductCard = ( {image, name, category, price, quantity} ) => {

  //const [quantity, setQuantity ] = useState(0);

  const { addItemCart, updateItemInCart, deleteItemFromCart, cart} = useCartStore();
   ...
   <div className="relative">
    ...
    {quantity === 0 ? (
      ...
      <img 
        ...
        alt="icon decrement quant justify-between items-centerity" />
